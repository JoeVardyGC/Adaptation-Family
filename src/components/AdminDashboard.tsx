...
export default function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  const handleOpenAddModal = () => {
    ...
    setMemberFormImage("/images/team/Adaptation.jpeg");
            ...
            >
              ...
              <form onSubmit={handleSaveMember} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {/* Or input direct image path/URL link */}
                  <div className="mt-2 flex flex-col gap-1">
                    <span className="text-[10px] font-bold text-[#5d5e64] uppercase tracking-wide">Or enter image path or web URL:</span>
                    <input 
                      type="text" 
                      value={memberFormImage && memberFormImage.startsWith("data:") ? "" : memberFormImage}
                      onChange={(e) => setMemberFormImage(e.target.value)}
                      placeholder="/images/team/member1.jpg or https://..."
